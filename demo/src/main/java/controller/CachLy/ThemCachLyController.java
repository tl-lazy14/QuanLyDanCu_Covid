...
public class ThemCachLyController implements Initializable {
    ...
    private void save(MouseEvent event) {
        LocalDate ngayBatDau = ngayBatDauF.getValue();
            if (ngayBatDau==null || idNguoiKhaiBao==-1||noiCachLyF.getText().isEmpty()||lyDoF.getText().isEmpty()||mucDoF.getValue()==null) {
    ...
    private void insert() {
        CachLyRepo.themcachly(new CachLy(idNguoiKhaiBao,Date.valueOf(ngayBatDauF.getValue()),14,noiCachLyF.getText(),mucDoF.getValue(),lyDoF.getText()));
    }
